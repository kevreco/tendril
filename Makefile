...
CPPFLAGS += -DSOURCE_REVISION=$(SOURCE_REVISION)
endif

all: app
	
app: libtendril.a
	$(CXX) $(CPPFLAGS) ./src/app/build.cpp  libtendril.a -std=c++11 -o $(OUTPUT) $(LIBS) $(WEBGL_VER) -O2 --preload-file resources@/ $(USE_WASM) -I$(IMGUI_DIR) -I$(IMGUI_DIR)/backends -I$(3RD_PARTY_DIR) -I$(TENDRIL_DIR) -I$(APP_DIR)
